        ...
        <div className="flex flex-col gap-4 py-4 md:py-10 px-4 md:gap-0  md:flex-row bg-neutral-900 md:p-20 text-white">
          <div>
            <div className="flex flex-col md:flex-row gap-4 md:gap-14 items-center">
              <div className="bg-black p-14 rounded-4xl text-lime-400 text-[110px] ">
                {" "}
                <FaWalkieTalkie />
              </div>
        ...
        <div className="flex flex-col gap-4 md:gap-0 md:flex-row md:justify-between ">
          <div className="relative w-[380px] h-[860px] md:w-[400px]">
            ...
            <img
              src={NigeriaFlag}
              alt="NigeriaLogo"
              className="absolute top-10 left-4 w-[32px] h-[32px]"
            />
            <div className=" absolute bottom-32 left-40 flex items-center justify-center rounded-2xl bg-red-600 w-[95px] h-[140px]">
              <img src={walkietalkie} alt="" className="w-[60px]" />
            </div>
          </div>
          ...
          <div className="relative w-[380px] h-[860px] md:w-[400px] overflow-x-hidden">
            ...
            <div className="flex items-center justify-between absolute top-0 w-full p-2">
              ...
              <div className="text-2xl border border-lime-600 text-white flex justify-center items-center rounded-[50px] w-[50px] h-[50px] ">
                <BiBell />
              </div>
            </div>
            ...
            <div className="flex absolute top-8 py-10">
              ...
              <div className="flex items-center  justify-center bg-lime-600 w-[60px] text-4xl h-[60px]">
                <img src={replay} alt="" />
              </div>
              <div className="flex items-center  justify-center bg-white w-[60px] h-[60px]">
                <img src={icons8group} alt="" />
              </div>
              <div className="flex items-center  justify-center bg-black w-[60px] h-[60px]">
                <img src={circumlocationon} alt="" />
              </div>
            </div>
            ...
            <div className="absolute flex items-center justify-center px-1.5 md:px-4 h-[90px] top-75">
              <div className="flex flex-col px-4 items-center bg-red-700 gap-12   w-[30px]  h-full py-2">
                <div className="w-[14px] h-[14px]">
                  <img src={carboncheckbox} alt="" className="w-full h-full" />
                </div>
                <div className="w-[14px] h-[14px]">
                  <img src={Vectorbox} alt="" className="w-full h-full" />
                </div>
              </div>

              <div className="  flex flex-col gap-2 px-1  bg-white  w-full h-full py-2">
                <div className="flex justify-center items-center gap-1">
                  <p className="tracking-wide font-bold text-[12px]">
                    Emergency Room
                  </p>
                  <div>
                    <img src={mdimessagesecureblack} alt="" />
                  </div>
                  <div>
                    <img src={carbonibmcloudsysdigsecure} alt="" />
                  </div>
                  <div>
                    <img src={fluentsyncoff20regular} alt="" />
                  </div>
                  <div>
                    <img src={fluentchat20regular} alt="" />
                  </div>
                  <div>
                    <img src={volume} alt="" className="w-6" />
                  </div>
                  ...
                  <div>
                    <img src={motorcycle1} alt="" />
                  </div>
                  <div>
                    <img src={gameiconsnetworkbars} alt="" />
                  </div>
                </div>
                <div>
                  <img
            ...
            <div className="absolute flex items-center justify-center px-1.5 md:px-4 h-[90px] top-[500px]">
              ...
              <div className="  flex flex-col gap-2 px-1  bg-white  w-full h-full py-2">
                <div className="flex justify-center items-center gap-1">
                  ...
                  <div>
                    <img src={ionvolumemediumblack} alt="" className="w-6" />
                  </div>
                  <div className="flex  gap-[1px] ">
                    <div className="h-2 w-0.5 bg-lime-700 "></div>
                    <div className="h-2 w-0.5 bg-lime-700 "></div>
        ...
        <div className="px-4 md:px-10 py-10">
          <div className="flex flex-row justify-between items-center">
            <div className="flex items-center gap-4">
              ...
              <p className="text-white px-8 py-4 grid items-center justify-center bg-lime-600 rounded-4xl text-[15px] md:text-[30px] font-bold">
                App Description
              </p>
            </div>
          ...
          <div className="md:px-16">
            ...
            <p className="text-[14px] md:text-[20px]">
              iZurvive provides you with DayZ and Arma 3 maps, lets you place
              tactical markers (player positions, tents, meeting points,..) on
              it and automatically shares those markers with the friends in your
              group - without the need for accounts, a registration or other
              services! Furthermore it provides a loot-map for DayZ.
            </p>
            <p className="py-4 text-[14px] md:text-[20px]">
              {" "}
              Finding and coordinating your team in the huge open world of DayZ
              and Arma 3 has never been easier!
            </p>
          </div>

          <div className="flex flex-col md:flex-row items-center md:gap-10 md:py-10">
            <div className="flex justify-center items-center w-[100px] h-[100px] bg-lime-800 rounded-[50px]">
              {" "}
              <img src={defcommlogo} alt="" className="w-[50px] md:w-[70px]" />
            </div>
