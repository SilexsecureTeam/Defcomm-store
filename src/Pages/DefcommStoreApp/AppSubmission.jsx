      ...
      <div className="container mx-auto px-4 space-y-8">
        ...
        <div className="w-full max-w-[1280px] mx-auto flex flex-col md:flex-row gap-y-6">
          ...
          <div className="bg-[#89AF20] rounded-t-2xl md:rounded-l-2xl md:rounded-tr-none py-6 px-6 flex justify-center">
            <img src={VectorA} alt="platform" className="max-w-[200px] h-fit" />
          </div>
            ...
            {currentStep === 1 && (
              <>
                ...
                <div className="space-y-6">
                  ...
                  {["App Bundles", "Release Name", "Version", "Copyright"].map(
                    (field, i) => (
                ...
                <div className="space-y-6">
                  ...
                  <div className="pl-2 space-y-6">
                    ...
                    <ul className="list-disc pl-6 text-sm space-y-2">
                      ...
                      <li>
                        “Third-party partners” include analytics tools, SDKs...
                      </li>
                    </ul>
                    <p className="text-sm">
                      View the{" "}
                      <span className="underline">full list of questions</span>.
                    </p>
            ...
            {currentStep === 3 && (
              <>
                ...
                <div className="flex flex-col items-center space-y-6">
                  ...
                  <p className="text-sm">Data is not collected from this app</p>
                </div>
              </>
            )}
