...
function MedicalApp() {
  ...
  return (
    <>
      <Nav />
      <div className="bg-black px-4 py-20 text-white w-full md:py-30">
          ...
          <div className=" w-full px-4 bg-white text-black py-12 md:px-10">
            <div className="md:flex relative">
              <div className="w-[300px]">
                <h1 className="text-[16px] z-10 font-bold">
                  iSurvive-Map for Military Operations
                </h1>
                <p className="text-[12px] z-10">
                  iSurvice provides you with DayZ and Arma 3 maps, lets you
                  place tactical markers (player positions, tents, meeting
                  points,..) on it and automatically shares those markers with
                  the friends in your group - without the need for accounts, a
                  registration or other services! Furthermore it provides a
                  loot-map for DayZ.
                </p>
                <h1 className="text-[12px] font-bold pt-10 text-lime-900">
                  Updated on
                </h1>
                ...
                <div className="flex pt-10 items-center gap-2">
                  ...
                  <p className="text-[10px]">MOBILE PHONE</p>
                </div>
                <div className="flex py-4 gap-2">
                  <p>
                    <LuLaptopMinimal />
                  </p>
                  <p className="text-[12px]">DEFCOM-PC</p>
                </div>
              </div>
            ...
            <div className=" flex items-center justify-between pt-20">
              ...
              <div>
                ...
                <p className="text-[14px] md:text-[16px]">
                  New way to write note, right there
                </p>
              </div>
              <button
                onClick={() => {
                ...
                className="flex items-center text-[30px] cursor-pointer justify-center w-[64px] h-[64px] text-white bg-lime-600 rounded-xl"
              >
