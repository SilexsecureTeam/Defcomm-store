...
function WhyUs() {
    ...
    const faqData = [
        ...
        },
        {
            ...
            subanswer: '~ Cybersecurity and privacy-enhancing software.',
            answerthree: '- Enbaddled security solutions for hadware integration.',
        },
        {
    ...
    return (
     <div className='bg-black w-full px-4 py-10 md:px-10 md:py-24  '>
        ...
        <div className='md:flex gap-10 px-4 pt-10 md:px-30 md:pt-30 '>
