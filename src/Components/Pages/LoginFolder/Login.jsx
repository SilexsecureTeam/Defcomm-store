...
function Login() {
  ...
  //For down rotation div
    ...
    const rotationYscrollDown = useTransform(scrollYProgress, [0, 1], ["0deg", "360deg"])
    ...
    return (
        <div className='relative bg-deffcom-lime h-[900px]'>
            ...
            <div className='flex justify-center text-white h-[100%] pt-30'>
                 ...
                 style={{y: moveUp}}>
                    <SvgOne />
                    <p>Extra Dynamo Power. <br /> Waterproof And Anti-Dust</p>
                </motion.div>
                ...
                style={{y: moveUp}}>
                    <SvgTwo />
                    <p className='px-26 '>The Propeller is as Stong as <br /> Steel as a feather.</p>
                </motion.div>

                <motion.div 
                className='absolute left-[380px] top-58'
                style={{y: moveDown}}>
                    <p>Latest Version Of Wireless <br /> Remote Sensor Technology</p>
                    <SvgThree />
                </motion.div>
                ...
                <div className=' my-20 px-10 justify-center border-1 border-neutral-400/10 shadow-xl absolute ml-70 bg-deffcom-limetwo text-white w-[390px] h-[400px]'>
                    <form  onSubmit={submitForm}  className='flex gap-6 flex-col py-8' >
                        ...
                        <input type="username" name="username" onChange={handleChange} value={inputValue.username}  placeholder="username" className='  border border-neutral-400/20  outline-none rounded-xl px-10 py-2 w-[300px]'/>
                        <input type="password" name="password" onChange={handleChange} value={inputValue.password} placeholder='password' className='  border border-neutral-400/20 outline-none rounded-xl px-10 py-2 w-[300px]' />
                        <button className='py-3 rounded-xl bg-black'>Login</button>
                    </form>  
                    <div className='flex text-xs justify-between'>
                            <button className='text-lime-400 cursor-pointer'>Already have account?</button>
                            <button  onClick={() => {navigate("/register")}} className='cursor-pointer'>Sign up</button>
                    </div>
                </div>
            ...
            <div className='bg-deffcom-limetwo'>
                ...
                <p className='text-[18px] text-neutral-400'>Dronerly.Inc is a company producing the highest quality VR Drones with the latest technology.</p>
            </div>
            ...
            <div  className='flex items-center text-xs justify-between py-10 text-white pb-14 px-14'>
                ...
                <motion.div className="fixed right-4 z-30 bottom-40 md:right-20 text-lime-400 p-4 border border-lime-400 rounded-[50%]"
                ...
                <div>
                    <p>&copy;Copyright Defcomm, All Rights Reserved.</p>
                </div>
