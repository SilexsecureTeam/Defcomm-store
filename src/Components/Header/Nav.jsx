    ...
    return (
        <>
            <div className='fixed left-0 top-0 w-full z-10 bg-white  flex items-center justify-between  px-4 md:px-10 md:py-2'>
                ...
                <NavLink to="/"><div className='block md:hidden '>
                        <img src={defcomm} alt="" className='w-[80px] h-[10px]'/>
                    </div>
                </NavLink> 
                ...
                <div className='flex gap-4 items-center'>
                    <ul className='flex gap-4 text-sm'>
                        <li onClick={() => {navigate("/app")}} className='cursor-pointer'>GAMES</li>
                        <li onClick={() => {navigate("/app")}} className='cursor-pointer'>APP</li>
                        <li onClick={() => {navigate("/app")}} className='cursor-pointer'>BOOKS</li>
                        <li onClick={() => {navigate("/app")}} className='cursor-pointer'>TV</li>
                        <li onClick={() => {navigate("/login")}}  className='cursor-pointer font-bold hidden md:block'>LOGIN/REGISTER</li>
                    </ul>
            ...
            <div className={`md:hidden fixed left-0 top-[70px] w-full bg-white shadow-lg z-30 
                ...
                <ul className="grid gap-3 text-md ">
                    ...
                    <NavLink to="login"><li className='font-bold active hover:scale-110 px-10 duration-200 h-12 hover:bg-gray-200 flex gap-1 cursor-pointer items-center '>LOGIN/REGISTER</li></NavLink>
                </ul>
            </div>
